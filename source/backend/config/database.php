...
return [
    ...
    */
    ...
    'default' => env('DB_MAIN_CONNECTION', 'db-main'),
    ...
    */
    ...
    'connections' => [
        ...
        'db-queue' => [
            ...
            'port' => env('DB_QUEUE_PORT', '5432'),
            'database' => env('DB_QUEUE_DATABASE', 'laravel'),
            'username' => env('DB_QUEUE_USERNAME', 'root'),
            'password' => env('DB_QUEUE_PASSWORD', ''),
            'charset' => env('DB_QUEUE_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
            'sslmode' => 'prefer',
